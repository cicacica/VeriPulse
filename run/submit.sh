...
oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0 e0.1 i2" \
      "$(pwd)/sweep.sh 0.0 0.1"

oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0.05 e0.0 i2" \
      "$(pwd)/sweep.sh 0.05 0.0"

oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0.2 e0.0 i2" \
      "$(pwd)/sweep.sh 0.2 0.0"

oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0.05 e0.1 i2" \
      "$(pwd)/sweep.sh 0.05 0.1"

oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0.1 e0.05 i2" \
      "$(pwd)/sweep.sh 0.1 0.05"

oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0.1 e0.1 i2" \
      "$(pwd)/sweep.sh 0.1 0.1"

oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0.2 e0.05 i2" \
      "$(pwd)/sweep.sh 0.2 0.05"

oarsub -l /nodes=1/core=64,walltime=60:0:0 -p "host like 'tall%'" -n "dummy d0.2 e0.1 i2" \
